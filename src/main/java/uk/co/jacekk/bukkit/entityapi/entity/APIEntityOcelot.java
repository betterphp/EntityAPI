...
public class APIEntityOcelot extends EntityOcelot implements APIEntity {
	...
	public APIEntityOcelot(World world, SpawnReason spawnReason){
		super(world);
	...
	public APIEntityOcelot(World world){
