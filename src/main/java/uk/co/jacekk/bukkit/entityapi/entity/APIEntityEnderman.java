...
public class APIEntityEnderman extends EntityEnderman implements APIEntity {
	...
	public APIEntityEnderman(World world, SpawnReason spawnReason){
		super(world);
	...
	public APIEntityEnderman(World world){
