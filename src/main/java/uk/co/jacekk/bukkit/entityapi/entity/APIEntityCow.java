...
public class APIEntityCow extends EntityCow implements APIEntity {
	...
	public APIEntityCow(World world, SpawnReason spawnReason){
		super(world);
	...
	public APIEntityCow(World world){
