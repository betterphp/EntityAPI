...
public class APIEntityEnderDragon extends EntityEnderDragon implements APIEntity {
	...
	public APIEntityEnderDragon(World world, SpawnReason spawnReason){
		super(world);
	...
	public APIEntityEnderDragon(World world){
