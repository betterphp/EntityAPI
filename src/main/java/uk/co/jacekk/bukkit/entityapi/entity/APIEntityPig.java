...
public class APIEntityPig extends EntityPig implements APIEntity {
	...
	public APIEntityPig(World world, SpawnReason spawnReason){
		super(world);
	...
	public APIEntityPig(World world){
