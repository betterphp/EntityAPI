...
public class APIEntitySheep extends EntitySheep implements APIEntity {
	...
	public APIEntitySheep(World world, SpawnReason spawnReason){
		super(world);
	...
	public APIEntitySheep(World world){
