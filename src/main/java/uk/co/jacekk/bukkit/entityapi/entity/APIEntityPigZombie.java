...
public class APIEntityPigZombie extends EntityPigZombie implements APIEntity {
	...
	public APIEntityPigZombie(World world, SpawnReason spawnReason){
		super(world);
	...
	public APIEntityPigZombie(World world){
