...
public class APIEntitySnowman extends EntitySnowman implements APIEntity {
	...
	public APIEntitySnowman(World world, SpawnReason spawnReason){
		super(world);
	...
	public APIEntitySnowman(World world){
